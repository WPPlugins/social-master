...
if ( $show_display == 'on' ){
	if ($social_master_system_wide_facebook_display == "true"){
		...
		'js.src = "//connect.facebook.net/'.$social_master_system_wide_facebook_lang.'/sdk.js#xfbml=1&version=v2.9&appId='.$social_master_system_wide_facebook_id.'";' .
		'fjs.parentNode.insertBefore(js, fjs);' .
		'}(document, '.$socialspacer.'script'.$socialspacer.', '.$socialspacer.'facebook-jssdk'.$socialspacer.'));</script>' .
		'<div class="fb-like" data-href="'.$social_master_system_wide_facebook_page.'" data-share="true" data-action="like" data-layout="button_count" data-size="small" data-show-faces="false" style="width:450px !important; overflow: visible !important z-index:9999 !important"></div>' .
		'</div>';
	}
	else {
		echo '<div id="fb-like" style="width:133px; overflow: visible !important">' .
		...
		'fjs.parentNode.insertBefore(js, fjs);' .
		'}(document, '.$socialspacer.'script'.$socialspacer.', '.$socialspacer.'facebook-jssdk'.$socialspacer.'));</script>' .
		'<div class="fb-like" data-href="'.$uricurrent.'" data-share="true" data-action="like" data-layout="button_count" data-size="small" data-show-faces="false" style="width:450px !important; overflow: visible !important z-index:9999 !important"></div>' .
		'</div>';
	}
}
else{
